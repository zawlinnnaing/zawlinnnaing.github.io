      ...
      <section className="lg:flex block lg:gap-4">
        ...
        <div className="flex-grow max-w-screen">
          <section id="tldr" className={styles.aboutSection}>
            ...
            <p>
              I am <PrimarySpan>a software engineer</PrimarySpan>, who mainly
              works on <PrimarySpan>web development</PrimarySpan>. I have at
              least <PrimarySpan>3 years of experience</PrimarySpan> in{" "}
              <PrimarySpan>backend development</PrimarySpan>. For{" "}
              <PrimarySpan>frontend development</PrimarySpan>, I specialize
              mainly in{" "}
              <PrimarySpan>
                <AppLink href="https://reactjs.org/">React.js</AppLink>
              </PrimarySpan>{" "}
              and have intermediate experience in{" "}
              <PrimarySpan>
                <AppLink href="https://vuejs.org/">Vue.js</AppLink>
              </PrimarySpan>
            ...
            <ol className="list-disc ml-8">
              <li>Architect and develop web apps both backend and frontend.</li>
              <li>
                Can also work on Deep learning/Machine learning if needed.
              </li>
              <li>
                Setup and Deploy web apps on Docker, Kubernetes and DigitalOcean
                droplets.
              </li>
              <li>
          ...
          <section id="backend" className={styles.aboutSection}>
            ...
            <p className="my-4">
              ...
              <AppLink href="https://laravel.com/">PHP(Laravel)</AppLink> and
            ...
            <ul className="list-disc ml-8">
              ...
              <li>Developing the backend system using Node.js and Laravel.</li>
              <li>
              ...
              <li>
                Working with APIs, including integration with third-party APIs,
                RESTful API development and GraphQL development.
              </li>
              <li>Writing unit tests and integration tests</li>
              <li>
                Containerization of web applications using Docker and deploying
                multiple services using Kubernetes and Nginx load balancer..
              </li>
            </ul>
          </section>
          <SectionHr />
          <section id="frontend" className={styles.aboutSection}>
            <h1 className={styles.aboutSectionTitle}>Frontend Engineering</h1>
            <p>
              I have built{" "}
              <span className="font-bold">3 enterprise-level web apps</span> and{" "}
              <span className="font-bold">2 websites</span> (including this one)
              using <AppLink href="https://reactjs.org/">React.js</AppLink>. I
              also have experience in building{" "}
              <span className="font-bold">
                3+ small to medium sized applications
              </span>{" "}
              using <AppLink href="https://vuejs.org/">Vue.js</AppLink>. Even
              though I am not as experience in Vue.js as React.js, I can
              transfer my knowledge regarding with architectural patterns and
              principles from React. Thus, I believe that I can build quality
              apps with both frameworks. I can also setup{" "}
              <AppLink href="https://web.dev/progressive-web-apps/">
                PWA
              </AppLink>{" "}
              using above mentioned frameworks. I am currently a fan of writing{" "}
              ...
              <ul className="list-disc ml-8">
                ...
                <li>
                  Refactoring codebase to implement Redux architecture and pure
                  components, for better maintainability, separation of
                ...
                <li>Writing unit tests and behavioral drive tests.</li>
                <li>
